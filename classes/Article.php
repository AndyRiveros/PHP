...
*
* @param object Sconn Connection to the database
*
...
protected function validate()
{
    ...
    if ($this->published_at != ''){
        $date_time = date_create_from_format('Y-m-d H:i:s', $this->published_at->format('Y-m-d H:i:s'));
 ...
 * @param object $conn Connection to the database
 * 
 * @return boolean True if the delete was succesfull, false otherwise
 */
